...
namespace TelegramChatBlazor.DAL.Migrations
{
    ...
    [Migration("20220706170141_update_messages")]
    partial class update_messages
    {
            ...
            modelBuilder.Entity("TelegramChatBlazor.DAL.Entities.Bot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7516),
                            Name = "Jironimo",
                        ...
                        {
                            Id = 2L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7790),
            ...
            modelBuilder.Entity("TelegramChatBlazor.DAL.Entities.Manager", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7918),
                            Email = "testEmail@gmail.com",
                            ImgPath = "https://ps.w.org/user-avatar-reloaded/assets/icon-256x256.png?rev=2540745",
                            LastOnline = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7921),
                            Name = "Alex Yesipov"
                        },
                        new
                        {
                            Id = 2L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7939),
                            ...
                            LastOnline = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7942),
                            Name = "Alex Ivanov"
                        },
                        new
                        {
                            Id = 3L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7956),
                            Email = "testEmail3@gmail.com",
                            ImgPath = "https://www.kindpng.com/picc/m/163-1636340_user-avatar-icon-avatar-transparent-user-icon-png.png",
                            LastOnline = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7959),
                            Name = "Kate Yesipova"
                        },
                        new
                        {
                            Id = 4L,
                            CreateAt = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7974),
                            Email = "testEmail4@gmail.com",
                            ImgPath = "https://image.pngaaa.com/345/1582345-middle.png",
                            LastOnline = new DateTime(2022, 7, 6, 20, 1, 41, 432, DateTimeKind.Local).AddTicks(7976),
                            Name = "Alex Pupkin"
                        });
                });
